...
class AppConstants {
  static const String APP_NAME = 'Saree3';
  ...
  //MESSAGING
  static const String GET_DELIVERYMAN_MESSAGE_URI = '/api/v1/customer/message/get-deliveryman-message';
  static const String GET_ADMIN_MESSAGE_URL = '/api/v1/customer/message/get-admin-message';
  static const String GET_STORE_MESSAGE_URL = '/api/v1/customer/message/get-store-message';
  static const String SEND_MESSAGE_TO_ADMIN_URL = '/api/v1/customer/message/send-admin-message';
  static const String SEND_MESSAGE_TO_DELIVERYMAN_URL = '/api/v1/customer/message/send-deliveryman-message';
  static const String SEND_MESSAGE_TO_STORE_URL = '/api/v1/customer/message/send-store-message';
